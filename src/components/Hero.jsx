...
const Hero = () => {
  const heroDescription = `Join Bangladesh's most active coding community. Share knowledge, win prizes, and build your tech network - all for free!`;
          ...
          <div className="text-center">
            ...
            >
              ...
              <span className="text-transparent bg-gradient-to-r bg-clip-text from-primaryColor via-primaryColor to-yellow-100">
                Shape Bangladesh&apos;s Tech Future.
              </span>
            </motion.h1>
